...
![Работа с файлами и директориями](./image/2.1i2i3i4.png){ #fig:001 width=70% }
...
![Создание, переименование и перемещение файлов](./image/2.5i6i7i8.png){ #fig:002 width=70% }
...
chmod 664 feathers
```
![Установка опций](./image/3.png){ #fig:003 width=70% }
...
![Просмотр содержимого файла](./image/4.1.png){ #fig:004 width=70% }
...
![Копирование и перемещение файлов](./image/4.2i3i4i5.png){ #fig:005 width=70% }
...
![Лишение владельца права на чтение файла](./image/4.6i7.png){ #fig:006 width=70% }
...
![Добавление права на чтение](./image/4.8i9.png){ #fig:007 width=70% }
...
![Лишение права на выполнение](./image/4.10.png){ #fig:008 width=70% }
...
![Добавление права на выполнение](./image/4.11i12.png){ #fig:009 width=70% }

### Прочитал man по командам mount, fsck, mkfs, kill и кратко их охарактеризовал, приведя примеры. (рис. [-@fig:010])

![Документации к командам](./image/5.png){ #fig:010 width=70% }
